    ...
    <div class="col-sm-12">
        ...
        <div class="resume">
            <header class="page-header">
                <h4 class="page-title">Profile of ${user.fullName}</h4>
                <small><i class="fa fa-clock-o"></i> Last Updated on:
                    <time>Sunday, October 05, 2014</time>
                </small>
            </header>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="col-xs-12 col-sm-4">
                                        <figure>
                                            <img class=" img-responsive" alt="" src='/images/blank-profile-hi.png'
                                    ...
                                    <div class="col-xs-12 col-sm-8">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><i
                                                    class="fa fa-envelope-o"> </i> ${user.address.address} </li>
                                            <li class="list-group-item"><i class="fa fa-phone"> </i> ${user.phoneNumber}
                                            </li>
                                            <li class="list-group-item"><i class="fa fa-at"> </i> ${user.email}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bs-callout bs-callout-danger">
                            ...
                            <p>
                                ...
                                te pri duis timeam scaevola, nam postea diceret ne. Cum ex quod aliquip mediocritatem,
                                mei habemus persecuti mediocritatem ei.
                            </p>

                            <p>
                                Odio recteque expetenda eum ea, cu atqui maiestatis cum. Te eum nibh laoreet, case
                                nostrud nusquam an vis.
                                Clita debitis apeirian et sit, integre iudicabit elaboraret duo ex. Nihil causae
                                adipisci id eos.
                            ...
                            <ul class="list-group">
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <p class="list-group-item-text">
                                        ...
                                        vel vidit mollis complectitur. Quis verear mel ne. Munere vituperata vis cu,
                                ...
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <ul>
                                        <li>
                                            Lorem ipsum dolor sit amet, ea vel prima adhuc, scripta liberavisse ea quo,
                                            te vel vidit mollis complectitur.
                                            Quis verear mel ne. Munere vituperata vis cu, te pri duis timeam scaevola,
                                            nam postea diceret ne. Cum ex quod aliquip mediocritatem, mei habemus
                        ...
                        <div class="bs-callout bs-callout-danger">
                            ...
                            <ul class="list-group">
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <div class="progress">
                                        <div data-placement="top" style="width: 70%;" aria-valuemax="100"
                                             aria-valuemin="0" aria-valuenow="1" role="progressbar"
                                             class="progress-bar progress-bar-success">
                                    ...
                                    <div class="progress">
                                        <div data-placement="top" style="width: 65%;" aria-valuemax="100"
                                             aria-valuemin="0" aria-valuenow="1" role="progressbar"
                                    ...
                                    <div class="progress">
                                        <div data-placement="top" style="width: 60%;" aria-valuemax="100"
                                    ...
                                    <div class="progress">
                                        <div data-placement="top" style="width: 10%;" aria-valuemax="100"
                                             aria-valuemin="0" aria-valuenow="50" role="progressbar"
                                    ...
                                    <div class="progress-meter">
                                        <div style="width: 25%;" class="meter meter-left"><span class="meter-text">I suck</span>
                                        </div>
