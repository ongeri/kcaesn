            ...
            function Y() {
                ...
                c.on("mouseup", function () {
                    ...
                    if (n = t(e.target))x(n) ? (e.preventDefault(),
                        G(A(n))) : (J(), r(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY)); else {
                        J(), re.hide();
