...
public class PartnersFormController extends BaseFormController {
    ...
    public PartnersFormController() {
        setCancelView("redirect:partnerss");
        setSuccessView("redirect:partnerss");
    }
    ...
    throws Exception {
        ...
        if (!StringUtils.isBlank(idpartners)) {
            return partnersManager.get(new Integer(idpartners));
        }
    ...
    throws Exception {
        ...
        if (request.getParameter("delete") != null) {
            ...
            if (!isNew) {
                success = "redirect:partnersform?idpartners=" + partners.getIdpartners();
            }
        }
